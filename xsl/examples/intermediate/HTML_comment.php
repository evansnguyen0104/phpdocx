...
$docx = new CreateDocx();
$html = '<p>This is some HTML code with a link to <a href="http://www.2mdc.com">2mdc.com</a> and a random image: <img src="../files/img/logo_header.jpg" width="35px" height="35px" style="vertical-align: -25px"></p>';
