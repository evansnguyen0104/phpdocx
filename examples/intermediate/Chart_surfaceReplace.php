...
/**
 * Replace the data from a surface chart with the data give by the client
 *
 * @category   Phpdocx
 * @package    examples
...
$source = "../files/example_surface_chart.docx";
$target = '../docx/example_surface_chart_replace_data.docx';
$data = array(
    0 => $completedData,
    1 => $completedData,
);
