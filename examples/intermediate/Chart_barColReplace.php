...
/**
 * Replace the data from a bar/col chart with the data give by the client
 *
 * @category   Phpdocx
 * @package    examples
...
$source = "../files/example_bar_col_chart.docx";
$target = '../docx/example_bar_col_chart_replace_data.docx';
$data = array(
	0 => $simpleData,
	1 => $completedData,	
);
